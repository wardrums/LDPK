...
#define CLASS_LDP_SDV         tde4_ldp_anamorphic_deg_6
#define CLASS_IOP_SDV     iop_tde4_ldp_anamorphic_deg_6
#define CREATE_SDV create_iop_tde4_ldp_anamorphic_deg_6

//! @file nuke_ld_3de4_anamorphic_degree_6.C
...
static const char* const CLASS = "LD_3DE4_Anamorphic_Degree_6";

// This text will be displayed in a popup help box on the node's panel:
static const char* const HELP = "3DE4 anamorphic lens distortion model, higher order.\n";

//! Nuke plugin based on tde4_ldp_anamorphic_deg_6
class iop_tde4_ldp_anamorphic_deg_6:public nuke_ld_3de4_base
	{
public:
...
// g++ -g -O2 -shared -fPIC ld_3de4_anamorphic_degree_6.C nuke_ld_3de4_base.C -I $server/software/linux64/nuke/Nuke7.0v9/include -I ../../include -L $server/software/linux64/nuke/Nuke7.0v9/lib -o ../../compiled/nuke/Nuke7.0/LD_3DE4_Anamorphic_Degree_6.so
