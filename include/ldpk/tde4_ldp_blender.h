...
#ifndef tde4_ldp_blender_sdv
#define tde4_ldp_blender_sdv

#include <ldpk/ldpk_ldp_builtin.h>
#include <ldpk/ldpk_blender_distortion.h>

//! @file tde4_ldp_blender.h
...
class tde4_ldp_blender:public ldpk::ldp_builtin<VEC2,MAT2>
	{
private:
	...
	ldpk::blender_distortion<vec2_type,mat2_type> _distortion;
...
// Mutex initialized and destroyed in baseclass.
	...
	bool getModelName(char *name)
		...
		strcpy(name,"3DE Blender Model [Plugin]");
#else
		strcpy(name,"3DE Blender LD Model");
#endif
		return true;
		}
...
template <class VEC2,class MAT2>
const char* tde4_ldp_blender<VEC2,MAT2>::_para[5] = {
	"1st Distortion",
    "2st Distortion",
    "3st Distortion",
    "1st cen",
