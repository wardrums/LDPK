...
public:
	...
	//! @brief calculate the Jacobian matrix of the undistort()-Method by means of difference quotients.
	//! This is the default implementation. Also use it for testing your own implementation of getJacobianMatrix().
	...
	virtual bool getJacobianMatrix(double x0, double y0, double &m00, double &m01, double &m10, double &m11)
		{
		return getJacobianMatrixDQ(x0,y0,m00,m01,m10,m11);
		}
